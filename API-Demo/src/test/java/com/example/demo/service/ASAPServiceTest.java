...
//@PrepareForTest(ASAPPeerFS.class)
...
//
//        PowerMockito.mockStatic(ASAPPeerFS.class);
//
...
//        Mockito.verify(ASAPPeerFS.createASAPPeer(name,PEERS_TEST_ROOT_FOLDER+"/"+name,chunkReceivedListener));
//
