...
import com.example.demo.service.asap.management.ASAPManagementMessageHandler;
import com.example.demo.service.asap.protocol.*;
import com.example.demo.service.asap.util.Helper;
import com.example.demo.service.asap.util.Log;
import com.example.demo.service.crypto.ASAPCommunicationCryptoSettings;
import com.example.demo.service.crypto.ASAPCryptoAlgorithms;
import com.example.demo.service.crypto.BasicCryptoKeyStorage;
    ...
    public void handleUndecryptableMessage(
        ...
        try {
            ASAPEngine undecryptEngine =
                    this.getASAPEngine(FORMAT_UNDECRYPTABLE_MESSAGES);
